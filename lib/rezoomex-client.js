...
export class RezoomexApiClient {
    ...
    async getAllProjects() {
        try {
            // Based on Python server: /v1/requirements/projects/{product_code}
            // For now, we'll need to get user info first to determine available projects
            // This is a limitation - we need a different endpoint to list all projects
            throw new Error('getAllProjects not yet implemented - need endpoint to list all user projects');
        } catch (error) {
