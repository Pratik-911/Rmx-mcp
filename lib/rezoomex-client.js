...
export class RezoomexApiClient {
    ...
    async getAllProjects() {
        try {
            ...
            // Note: This should be empty by default to avoid hardcoded project assumptions
            // Users should have projects discovered dynamically through proper API endpoints
            const commonProjectPatterns = [
                // Add patterns as discovered from user feedback or API discovery
            ];
